function feedbackBar() {
    return (
        <div className="flex flex-wrap w-full border-2">
            ...
            <div className="flex-1 border bg-indigo-200 flex justify-center items-center hover:shadow-lg hover:font-bold hover:scale-110 transition-transform">E3</div>
            ...
            <div className="flex-1 border bg-indigo-200 flex justify-center items-center hover:shadow-lg hover:font-bold hover:scale-110 transition-transform">M6</div>
        </div>
    );
}
